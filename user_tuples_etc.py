...
def illustrate_tuples():
    ...
    """
    logger.info("==============Illustrate Tuples===============")
    # Create some tuples
    student1 = ("Annie", "Corera", 101, "Information Technology", "Second")
    student2 = ("Elisabeth", "Swann", 102, "Computer Science", "First")
    student3 = ("Brad", "Pitt", 103, "Business Management", "Second")

    logger.info(f"student1 = {student1}")
    logger.info(f"student2 = {student2}")
    logger.info(f"student3 = {student3}")

    # tuple concatenation
    tupleCat = student1 + student2

    # tuple repetition
    student1Thrice = student1 * 3

    # just add space = space inside the curly braces
    # it will print the name of the variable and the value
    logger.info(f"{student1 = }")
    logger.info(f"{student2 = }")
    logger.info(f"{tupleCat = }")
    logger.info(f"{student1Thrice = }")
...
def illustrate_sets():
    ...
    # set union
    setC = setA | setB
    logger.info(f"Union of setA and setB = {setC}")

    # set intersection
    setD = setA & setB
    logger.info(f"Intersection of setA and setB = {setD}")

    # set difference
    setE = setA - setB
    logger.info(f"Difference of setA and setB = {setE}")
...
def illustrate_dictionaries():
    ...
    """
    logger.info("==============Illustrate Dictionaries===============")
